...
<template>
    <div class="dropdown-background" v-if="headerStore.userProfileDropdownIsOpened" @click="headerStore.switchDropdown('user-profile')"></div>
    <div class="dropdown-container">
        <div class="button" id="avatar-container" title="Profile" @click="headerStore.switchDropdown('user-profile')">
        ...
        <div class="dropdown" v-if="headerStore.userProfileDropdownIsOpened">
            ...
            <a class="link" href="#">
                <img class="link-icon" src="/images/logos/ratings.png" alt="Ratings">
